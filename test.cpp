...
int main() {
    ...
    b.state.board_map[make_pair(0, 2)] = WHITE_RING;
    ...
    b.state.white_rings.insert(make_pair(0, 2));
    ...
    Proper_Ply p2;
    get<0>(p2) = make_pair(0, 2);
    get<1>(p2) = make_pair(5, 2);
    ...
    cout<<b.state.board_map[make_pair(1,  2)]<<"$$$$$"<<endl;
    cout<<b.state.board_map[make_pair(4,  2)]<<"$$$$$"<<endl;
    //State c = Toggle(make_pair(1,2), make_pair(5,2), b.state);
    cout<<endl;
    State c = perform_proper_ply(b.state, b.player, p2);
    cout<<c.board_map[make_pair(0,  2)]<<"$$$$$"<<endl;
    cout<<c.board_map[make_pair(1,  2)]<<"$$$$$"<<endl;
    cout<<c.board_map[make_pair(2,  2)]<<"$$$$$"<<endl;
    cout<<c.board_map[make_pair(3,  2)]<<"$$$$$"<<endl;
    cout<<c.board_map[make_pair(4,  2)]<<"$$$$$"<<endl;
    cout<<c.board_map[make_pair(5,  2)]<<"$$$$$"<<endl;
    //string s3 = b.output_parse(p2);
    // b.checkfor5();
    //cout<<c.board_map[make_pair(2,  2)]<<"$$$$$"<<endl;
